...
a,b,c,d,e,f,g = read_data('final_punct_train.txt')
a1,b1,c1,d1,e1,f1,g1 = read_data('final_punct_dev.txt')
...
word_map, char_map, tag_map = create_maps(b+b1 ,f + f1,1,1)
...
def create_input_tensors(words, tags, probs, word_map, char_map, tag_map, is_punct):
    ...
    padded_is_punct = torch.LongTensor(padded_is_punct)
